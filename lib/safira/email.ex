                      ...
                      <div style="Margin-left: 20px;Margin-right: 20px;">
                        <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                          ...
                          <p style="Margin-top: 16px;Margin-bottom: 20px;">Olá, caro(a) participante,<br>
                            <br>
                            Está tudo pronto para o início da SEI'22! Para finalizar a criação da tua conta, basta clicares no botão abaixo para definir uma password para a tua conta.
                        </div>
                      </div>
