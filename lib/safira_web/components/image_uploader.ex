defmodule SafiraWeb.Components.ImageUploader do
  ...
  def image_uploader(assigns) do
    ~H"""
      ...
      <section phx-drop-target={@upload.ref} class={"transition-colors hover:cursor-pointer hover:bg-lightShade/30 dark:hover:bg-darkShade/20 border-2 border-dashed rounded-xl border-lightShade dark:border-darkShade #{@class}"} onclick={"document.getElementById('#{@upload.ref}').click()"}>
