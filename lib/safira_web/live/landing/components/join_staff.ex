defmodule SafiraWeb.Landing.Components.JoinStaff do
  @moduledoc false
  use SafiraWeb, :component

  def join_staff(assigns) do
    ~H"""
    <.link
      navigate="https://forms.gle/XWHoNu4LjC8BogF68"
    ...
    >
      <span class="relative z-10">Be a Staff</span>
    </.link>
    """
  end
end
